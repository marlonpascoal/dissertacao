load ga_precise_known_nc0_part1;
load politopos_estabilizaveis_sof_comganho_vertices_Bprecknown;
load sistemas_selecionados_estatistica;

for (i = 1:20)%[5, 6, 7, 10, 13, 14, 15, 16, 21, 24, 26, 30, 32, 33, 34, 35, 36, 39, 40, 41, 43, 44, 45, 49])
...
%         end
        ...
        save ga_precise_known_nc0_part1 normas_ia_v3_nc0;
    end
end