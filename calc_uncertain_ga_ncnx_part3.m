...
load normas_ia_uncertain_ga_ncnx_part3;
load selected_uncertain;
load politopos_estabilizaveis_sof_comganho_vertices_Bprecknown_teste;

for (i = 11:15)%[5, 6, 7, 10, 13, 14, 15, 16, 21, 24, 26, 30, 32, 33, 34, 35, 36, 39, 40, 41, 43, 44, 45, 49])
...
%         end
        ...
        save normas_ia_uncertain_ga_ncnx_part3 normas_ia_uncertain_ga_ncnx;
    end
end