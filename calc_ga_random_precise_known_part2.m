load ga_precise_known_nc0_part2;
load politopos_estabilizaveis_sof_comganho_vertices_Bprecknown;
load sistemas_selecionados_estatistica;

for (i = 21:40)%[5, 6, 7, 10, 13, 14, 15, 16, 21, 24, 26, 30, 32, 33, 34, 35, 36, 39, 40, 41, 43, 44, 45, 49])
...
%         end
        ...
        normas_ia_v3_nc0 = setfield(normas_ia_v3_nc0, ['system_' num2str(i)] ,normas);
        
        
        save ga_precise_known_nc0_part2 normas_ia_v3_nc0;
    end
end