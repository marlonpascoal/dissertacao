load normas_ia_v3_ncnx_part2;
load politopos_estabilizaveis_sof_comganho_vertices_Bprecknown;
load sistemas_selecionados_estatistica;

for (i = 22:40)%[5, 6, 7, 10, 13, 14, 15, 16, 21, 24, 26, 30, 32, 33, 34, 35, 36, 39, 40, 41, 43, 44, 45, 49])
...
%         end
        ...
        save normas_ia_v3_ncnx_part2 normas_ia_v3_ncnx;
    end
end