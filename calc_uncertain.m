...
%         end
        ...
        normas_ia_uncertain_ncnx = setfield(normas_ia_uncertain_ncnx, ['system_' num2str(i)] ,normas);
        
        
        save normas_ia_uncertain_ncnx normas_ia_uncertain_ncnx;
    end
end